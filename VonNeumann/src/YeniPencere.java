...
public class YeniPencere extends JFrame {
		...
		timer = new Timer(wait, new ActionListener() {
	        public void actionPerformed(ActionEvent e1) {
	        	try {
					...
					JOptionPane.showMessageDialog(getOwner(), "geçersiz bir adres kullanıldı", "Hata", JOptionPane.ERROR_MESSAGE);
					timer.stop();
	        	} catch (regOverflowException e2) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(getOwner(), "register mevcut değeri saklamak için yetersiz", "Hata", JOptionPane.ERROR_MESSAGE);
					timer.stop();
	...
	public YeniPencere(RAM ram) {
		...
		tabbedPane.addTab("Donanım", null, tab1, null);
